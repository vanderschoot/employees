...
public class IntegrationTest {
	...
	public void beginTransaction() {
        ...
        try {
    		departmentDao = (DepartmentDAO) context.lookup("java:global/employeesJSFH/DepartmentDAO");
    		employeeDao = (EmployeeDAO) context.lookup("java:global/employeesJSFH/EmployeeDAO");
    		userDao = (UserDAO) context.lookup("java:global/employeesJSFH/UserDAO");
    		roleDao = (RoleDAO) context.lookup("java:global/employeesJSFH/RoleDAO");
    		userroleDao = (UserRoleDAO) context.lookup("java:global/employeesJSFH/UserRoleDAO");
