...
public class EmployeeServiceImpl {
    ...
    public EmployeeServiceImpl() {
    	System.out.println("REST Webservice EmployeeServiceImpl created");
    }
    ...
    public Response listform(	@FormParam("page") @DefaultValue("-1") int page,
        ...
        List<Employee> found;
 		...
 		int start = (page -1) * rows; int count = 0;
 		String qry;
        if (departmentId >= 0) {
     		System.out.println("zoek employees voor department");
        	count = em.createQuery("SELECT COUNT(e) FROM Employee e where e.department.departmentId = " + departmentId, Long.class).getSingleResult().intValue();
        	...
        	count = em.createQuery("SELECT COUNT(e) FROM Employee e", Long.class).getSingleResult().intValue();
    ...
    @GET
    @RolesAllowed({"Administrator", "User"})
    public Response list(	@QueryParam("departmentId") @DefaultValue("-1") int departmentId) {
 	...
 	@Path("/listu")
    @GET
    public Response listu(	@QueryParam("departmentId") @DefaultValue("-1") int departmentId) {
