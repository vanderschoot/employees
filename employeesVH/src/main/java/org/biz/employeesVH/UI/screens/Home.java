...
public class Home extends CustomComponent {
	...
	private void createScreenHeader() {
		...
		Label label = new Label("employeesVH : a Vaadin Rich Client/Server Demo App for HyperSQL");		
	...
	private void createText() {	
		...
		Label text = new Label(
				...
				"The data access layer makes use of the Vaadin SQLContainer to access a HyperSQL (HSQLDB) 'in-memory' database." +
