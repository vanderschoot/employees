...
public class SecurityController {
    ...
    public String loggedin(@RequestParam("userName") String userName) {		
	   ...
	   ls = sec.loggedin(userName);

       logger.info("loggedin, ls.success = " +  ls.isSucces() + " ls.userName = " + ls.getUserName() +  " / ls.roles = " + ls.getRoles() +  " / ls.message = " + ls.getMessage());
