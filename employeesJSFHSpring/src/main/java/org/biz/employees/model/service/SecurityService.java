...
public class SecurityService  {
    ...
    public LoginStatus loggedin(String user) {
	        ...
	        if (auth != null) {
		        ...
		        System.out.println("currentuser = " + currentuser);
			        if (auth.isAuthenticated()) {
				        ...
				        return new LoginStatus(true,currentuser, getroles(currentuser), null);
			        } else {
			            System.out.println("user/currentuser : auth.isAuthenticated() = false");
			        	return new LoginStatus(false, null, null, "User niet ingelogd (isAuthenticated = false)");
			        }
	        } else {
	            System.out.println("user is NOT loggedin : auth = null");
	        	return new LoginStatus(false, null, null, "User niet ingelogd (auth=null)");        	
	        }
        } else {
            System.out.println("user is null");
        	return new LoginStatus(false, null, null, "User niet ingelogd (user=null)");        	       	
        }
    }
