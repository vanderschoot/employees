...
import org.biz.employeesVS.UI.screens.Help;
import org.biz.employeesVS.UI.screens.Home;
import org.biz.employeesVS.UI.screens.Login;
import org.biz.employeesVS.UI.screens.Register;
...
public class Header extends CustomComponent {
	...
	public Header(final MainApp app) {
		...
		btnLogout.addListener(new ClickListener() {
			@Override
			public void click(ClickEvent event) {
				ReturnStatus sts = app.getDataModel().getSoapServiceFactory().logout();
				if (sts != null) {
					if (sts.isSucces()) {
