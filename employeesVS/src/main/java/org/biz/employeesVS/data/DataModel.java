...
public class DataModel {
	...
	public boolean getData() {
		...
		ssf = new SoapServiceFactory(app);
	...
	private IndexedContainer getDepartments() {
		...
		List<Department> departments = ssf.getDepartments();
		if (departments != null) {
	...
	public ReturnStatus deleteDepartment(Object itemId) {
		...
		return ssf.deleteDepartment(departmentContainer.getItem(itemId).getItemProperty("ID").getValue().toString());
	}
	...
	public ReturnStatus updateDepartment(Object itemId, String name, String address, String budget) {
		...
		return ssf.updateDepartment(departmentContainer.getItem(itemId).getItemProperty("ID").getValue().toString(),
				name, address, budget);
	}
	...
	public ReturnStatus addDepartment(String name, String address, String budget) {
		...
		return ssf.addDepartment(name, address, budget);
	}

	private IndexedContainer getEmployees() {
		System.out.println("getEmployees");
		List<Employee> employees = ssf.getEmployees();
		IndexedContainer container = new IndexedContainer();
		...
		for (Employee emp : employees) {
			System.out.println("getEmployees, emp : " + emp.getFirstName());
			Object id = container.addItem();
	...
	public ReturnStatus deleteEmployee(Object itemId) {
		...
		return ssf.deleteEmployee(employeeContainer.getItem(itemId).getItemProperty("ID").getValue().toString());
	}
	...
	public ReturnStatus updateEmployee(Object itemId, String firstName, String lastName, Date birthDate, String departmentId) {
		...
		return ssf.updateEmployee(employeeContainer.getItem(itemId).getItemProperty("ID").getValue().toString(),firstName, lastName, birthDate,departmentId);
	}
	...
	public ReturnStatus addEmployee(String firstName, String lastName, Date birthDate, String departmentId) {
		...
		return ssf.addEmployee(firstName, lastName, birthDate, departmentId);
	}


	private IndexedContainer getUsers() {
		Collection<User> users = ssf.getUsers();
		IndexedContainer container = new IndexedContainer();
		...
		for (User usr : users) {
			System.out.println("getUsers, usr : " + usr.getUserName());
			Object id = container.addItem();
	...
	public ReturnStatus deleteUser(Object itemId) {
		...
		return ssf.deleteUser(userContainer.getItem(itemId).getItemProperty("ID").getValue().toString());
	}
	...
	public ReturnStatus updateUser(Object itemId, String email, String userName, String password) {
		...
		return ssf.updateUser(userContainer.getItem(itemId).getItemProperty("ID").getValue().toString(),email, userName, password);
	}
	...
	public ReturnStatus addUser(String email, String userName, String password) {
		...
		return ssf.addUser(email, userName, password);
	}


	public IndexedContainer getRoles() {
		List<Role> roles = ssf.getRoles();
		...
		for (Role role : roles) {
			System.out.println("getRoles, role : " + role.getName());
			Object id = container.addItem();
	...
	public ReturnStatus deleteRole(Object itemId) {
		...
		return ssf.deleteRole(roleContainer.getItem(itemId).getItemProperty("ID").getValue().toString());
	}
	...
	public ReturnStatus updateRole(Object itemId, String name) {
		...
		return ssf.updateRole(roleContainer.getItem(itemId).getItemProperty("ID").getValue().toString(),name);
	}

	public ReturnStatus addRole(String name) {
		System.out.println("addRole, name = " + name);
		return ssf.addRole(name);
	}


	private IndexedContainer getUserRoles() {
		List<UserRole> userroles = ssf.getUserRoles();
		IndexedContainer container = new IndexedContainer();
		...
		for (UserRole usrl : userroles) {
			System.out.println("getUserRoles, usrl : " + usrl.getUserRoleId());
			Object id = container.addItem();
	...
	public ReturnStatus deleteUserRole(Object itemId) {
		...
		return ssf.deleteUserRole(userroleContainer.getItem(itemId).getItemProperty("ID").getValue().toString());
	}
	...
	public ReturnStatus updateUserRole(Object itemId, String roleId, String userId) {
		...
		return ssf.updateUserRole(userroleContainer.getItem(itemId).getItemProperty("ID").getValue().toString(),roleId,userId);
	}

	public ReturnStatus addUserRole(String roleId, String userId) {
		System.out.println("addUserRole, roleId = " + roleId + " / userId = " + userId);
		return ssf.addUserRole(roleId,userId);
	}
	...
	public SoapServiceFactory getSoapServiceFactory() {
		return ssf;
	}
