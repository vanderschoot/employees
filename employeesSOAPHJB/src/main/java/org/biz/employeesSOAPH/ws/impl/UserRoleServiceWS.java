...
import org.biz.employeesSOAPH.ws.UserRoleService;
...
@WebService(
        ...
        endpointInterface = "org.biz.employeesSOAPH.ws.UserRoleService")
public class UserRoleServiceWS implements UserRoleService {
    @PersistenceContext
    private EntityManager em;

    public UserRoleServiceWS() {
    	System.out.println("SOAP Webservice UserRoleServiceWS created");
    }
