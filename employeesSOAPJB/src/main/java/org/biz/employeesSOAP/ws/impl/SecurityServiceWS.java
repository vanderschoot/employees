...
import org.biz.employeesSOAP.email.EmailSessionBean;
...
import org.biz.employeesSOAP.ws.SecurityService;

@WebService(
        portName = "SecurityPort",
        serviceName = "SecurityServiceWS",
        targetNamespace = "http://biz.org/wsdl",
        endpointInterface = "org.biz.employeesSOAP.ws.SecurityService")
@Stateless
...
/*
    @WebMethod
    public ReturnStatus getuser(@Context HttpServletRequest req) {
        System.out.println("getuser" + req.getRemoteUser());
	    return new ReturnStatus(true,req.getRemoteUser());
    }
*/    
