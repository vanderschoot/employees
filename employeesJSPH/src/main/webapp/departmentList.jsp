        ...
        <tbody>
            <c:forEach items="${departments}" var="dep">
                <tr>
                    ...
                    <td><a href="DepartmentController?action=edit&departmentId=<c:out value="${dep.departmentId}" />">Update</a></td>
                    <td><a href="DepartmentController?action=delete&departmentId=<c:out value="${dep.departmentId}" />">Delete</a></td>
                    <td align="center"><a href="EmployeeController?action=list&departmentId=<c:out value="${dep.departmentId}" />">-&gt;</a></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
