        ...
        <tbody>
            <c:forEach items="${users}" var="usr">
                <tr>
                    ...
                    <td><a href="UserController?action=edit&userId=<c:out value="${usr.userId}" />">Update</a></td>
                    <td><a href="UserController?action=delete&userId=<c:out value="${usr.userId}" />">Delete</a></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
