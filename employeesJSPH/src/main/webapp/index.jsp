...
<ul>
<li><a href="DepartmentController?action=list">Departments</a></li>
<li><a href="EmployeeController?action=list">Employees</a></li>
<li><a href="UtilController?action=createdatabase">Create Database</a></li>
</ul>
</div> <!-- content -->
<div class="push"></div>
</div> <!-- container -->
