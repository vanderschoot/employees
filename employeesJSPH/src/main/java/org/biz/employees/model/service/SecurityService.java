...
public class SecurityService  {
	...
	public SecurityService() {		
		System.out.println("EJB SecurityService created");
	}	
    ...
    public ReturnStatus loggedin(String user, HttpSession session) {
        ...
        if (currentuser == null) {
        	...
        	return new ReturnStatus(false, "Nobody is logged in");       	
        } else if (currentuser.equals(user)) {
            System.out.println("currentuser is loggedin");
	        return new ReturnStatus(true,getroles(user));
        } else {
            System.out.println("currentuser is NOT loggedin");
        	return new ReturnStatus(false, currentuser);
        }
    }
